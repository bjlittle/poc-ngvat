...
sst_threshold = sst_threshold.threshold(value=0, scalars="idx").threshold(scalars="faces")
...
for t in range(N_steps):
    ...
    pdata_sst_threshold[t] = mesh.threshold(value=0, scalars="idx").threshold(scalars="faces")
