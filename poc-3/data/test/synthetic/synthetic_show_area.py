...
p = pv.BackgroundPlotter(shape=(2, 3))

p.subplot(0, 0)
p.add_text("C4", font_size=font_size, shadow=shadow, font=font)
area = pdata_c4["area"]
...
p.subplot(0, 1)
p.add_text("C12", font_size=font_size, shadow=shadow, font=font)
area = pdata_c12["area"]
clim = [area.min(), area.max()]
...
p.subplot(0, 2)
p.add_text("C24", font_size=font_size, shadow=shadow, font=font)
area = pdata_c24["area"]
clim = [area.min(), area.max()]
...
p.subplot(1, 0)
p.add_text("C48", font_size=font_size, shadow=shadow, font=font)
area = pdata_c48["area"]
clim = [area.min(), area.max()]
...
p.subplot(1, 1)
p.add_text("C96", font_size=font_size, shadow=shadow, font=font)
area = pdata_c96["area"]
clim = [area.min(), area.max()]
...
p.subplot(1, 2)
p.add_text("C1048", font_size=font_size, shadow=shadow, font=font)
